...
#process.es_prefer_IdealGeometryRecord = XMLIdealGeometryESSource
### Try to do RecoLocalMuon on all muon detectors ###
#####################################################
from RecoLocalMuon.Configuration.RecoLocalMuon_cff import *
#process.localreco = cms.Sequence(muonlocalreco)
process.localreco = cms.Sequence(gemLocalReco)
...
open('GEMRecoFileDump.py','w').write(process.dumpPython())
